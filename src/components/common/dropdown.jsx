  ...
  return (
    <div id={wrapperId} className={`${props.wrapperclasses || ''} w-full relative`}>
      <input
        id={id}
        className={twMerge(
          `w-full h-14 sm:h-16 bg-transparent border-2 border-primary-base focus:ring-primary-base outline-none rounded-md text-gray-100 px-4 py-2 text-base font-normal hover:text-white transition duration-300 cursor-pointer hide-blink ${props.className}`,
          props.className,
        )}
