  ...
  return (
    <div className={twMerge("relative my-2 group", props.wrapperclasses || "")}>
      ...
      <input
        {...props}
        type={type || 'text'}
        className={twMerge(`w-full shadow-ds2 pr-4 py-2.5 lg:py-3.5 ${
          prefixIcon ? 'pl-14 group-hover:pl-16' : 'pl-4'
        } border-none text-sm font-semibold focus:ring-2 focus:ring-primary-base focus:outline-0 rounded-md transition-all duration-300`, props.className)}
